...
方法区和Java堆一样，为多个线程共用，它用于存储**类信息、常量、静态常量、即时编译后的代码**等数据。

## 内存溢出和栈溢出

![image-20211204001324041](https://cdn.jsdelivr.net/gh/TaoCesc/blogImages/imgs/image-20211204001324041.png)
